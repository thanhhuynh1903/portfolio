...
const projects = [
  ...
  },
  {
    ...
    description:
      "Built a cross-platform fitness coaching app with React Native & TypeScript for personalized health tracking. Synced with real-time biometric data (heart rate, steps, etc.) via Health Connect API. Integrated Firebase for push notificationsand used REST APIs for training plans and health metrics. Designed calendar and charts for performance tracking,applied Zustand for state management, and enhanced UI/UX with React Native Paper and custom charts.",
    image: "/project2.png",
    technologies: [
      "React Native",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "Built a responsive recipe search app with React v19 and TypeScript, supporting all device sizes. Integrated Spoonacular API for recipe filtering by cuisine, ingredients, and nutrition. Designed clean UI with Ant Design andEmotion. Enhanced UX with real-time feedback, skeleton loaders, and smooth navigation using React Router. Performance and code quality with Vite, ESLint,TypeScript.",
    image: "/project3.png",
    technologies: [
      "React v19",
      "TypeScript",
